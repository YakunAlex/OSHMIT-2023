...
2) Раунды на [codeforces.com](https://codeforces.com/contests) (учавствуете в соревновании на Div 3 или Div 4, потом *смотрите разбор и дорешиваете задачи*).

3) [Курс по C++ на степике](https://stepik.org/course/363/promo)

4) Есть много разных выездных школ, например ШМИТ, ЛКШ.

5) Школа программиста или что-нибудь похожее.
