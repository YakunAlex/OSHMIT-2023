...
1) Дорешивать acmp.ru (курс по C++, потом курс по олимпиадным задачам).

2) Раунды на codeforces.com (учавствуете в соревновании на Div 3 или Div 4, потом *посмотреть разбор и дорешать задачи*).
